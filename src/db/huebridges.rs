...
pub fn get_huebridge(conn: &mut SqliteConnection, id: i32) -> Result<HueBridge, diesel::result::Error> {
    conn.transaction(|conn| {
...
pub fn get_huebridges(conn: &mut SqliteConnection) -> Result<Vec<HueBridge>, diesel::result::Error> {
    conn.transaction(|conn| {
